...
function updateDependencies() {
    return (tree, context) => {
        ...
        const addDependencies = rxjs_1.of('cypress').pipe(operators_1.concatMap((packageName) => utils_1.getLatestNodeVersion(packageName)), operators_1.map((packageFromRegistry) => {
    ...
    return (tree, context) => {
        if (tree.exists('./angular.json')) {
            ...
            Object.keys(projects).forEach((project) => {
                ...
                const configFile = exports.getCypressConfigFile(angularJsonVal, project);
                if (configFile) {
